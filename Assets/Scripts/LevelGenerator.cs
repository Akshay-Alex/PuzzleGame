...
public class LevelGenerator : MonoBehaviour
{
    ...
    {
        level = new Level();
        level._levelName = "Level 2";
        level._startPoints.Add((new Vector2(0, 0)).ToString(), "#" + ColorUtility.ToHtmlStringRGBA(Color.red));
        level._startPoints.Add((new Vector2(0, 4)).ToString(), "#" + ColorUtility.ToHtmlStringRGBA(Color.red));
        level._startPoints.Add((new Vector2(1, 0)).ToString(), "#" + ColorUtility.ToHtmlStringRGBA(Color.green));
        level._startPoints.Add((new Vector2(1, 4)).ToString(), "#" + ColorUtility.ToHtmlStringRGBA(Color.green));
        level._startPoints.Add((new Vector2(2, 0)).ToString(), "#" + ColorUtility.ToHtmlStringRGBA(Color.blue));
        level._startPoints.Add((new Vector2(2, 4)).ToString(), "#" + ColorUtility.ToHtmlStringRGBA(Color.blue));
        level._startPoints.Add((new Vector2(3, 0)).ToString(), "#" + ColorUtility.ToHtmlStringRGBA(Color.yellow));
        level._startPoints.Add((new Vector2(3, 4)).ToString(), "#" + ColorUtility.ToHtmlStringRGBA(Color.yellow));
